...
"
" Modification of "oceandeep" color scheme, with "bold" attribute removed
" in GUI and terminal, but not in text console.
"
" Includes code from the original "oceandeep" color scheme, which can
" be found under the following URLs:
"
" * https://www.vim.org/scripts/script.php?script_id=368
...
let g:colors_name = "oceandeep-nobold"

"
" BEGIN Original oceandeep.vim script.
"
...
"
" END Original oceandeep.vim script.
"
...
if has("gui_running") || !empty($DISPLAY)
	...
	hi PmenuSbar	  cterm=NONE gui=NONE
