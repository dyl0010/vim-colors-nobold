...
"
" Modification of "elflord" color scheme shipped with Vim, with "bold"
" attribute removed in GUI and terminal, but not in text console.
"
" Requires original "elflord" color scheme.
"
" Maintainer of the original "elflord" color scheme:
...
" Load original "elflord" color scheme.
runtime colors/elflord.vim

let g:colors_name = "elflord-nobold"
...
if has("gui_running") || !empty($DISPLAY)
	...
	" just like in text console. In GUI, use blue color.
	"

	hi StatusLine ctermbg=DarkGray guibg=Blue
