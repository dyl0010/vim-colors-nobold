...
"
" Modification of "zellner" color scheme shipped with Vim, with "bold"
" attribute removed in GUI and terminal, but not in text console.
"
" Requires original "zellner" color scheme.
"
" Maintainer of the original "zellner" color scheme:
...
" Load original "zellner" color scheme.
runtime colors/zellner.vim

let g:colors_name = "zellner-nobold"
...
if has("gui_running") || !empty($DISPLAY)
	...
	"
	" Restore links, which were removed above.
	"
	...
	hi StatusLineTermNC ctermfg=Black guifg=LightGray
