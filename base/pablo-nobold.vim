...
"
" Modification of "pablo" color scheme shipped with Vim, with "bold"
" attribute removed in GUI and terminal, but not in text console.
"
" Requires original "pablo" color scheme.
"
" Maintainer of the original "pablo" color scheme:
...
" Load original "pablo" color scheme.
runtime colors/pablo.vim

let g:colors_name = "pablo-nobold"
...
if has("gui_running") || !empty($DISPLAY)
	...
	hi StatusLineTermNC guifg=#005500
